<lit-col width="12" class="d-flex justify-content-center">
    <div style="margin-top: 25vh;">
        ...
        <svg width="45px" height="100%" viewBox="0 0 169 263" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
        ...
        <span style="font-size:2rem;">{!! __lit('base.user_hello', ['user' => '<strong>'.lit_user()->first_name.'</strong>']) !!}.</span>
    </div>
</lit-col>
