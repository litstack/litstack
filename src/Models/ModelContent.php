...
class ModelContent extends Model implements HasMedia, TranslatableContract
{
    use HasMediaTrait, Translatable;

    protected $table = 'model_content';
    protected $translationModel = Translations\ModelContentTranslation::class;
    protected $appends = ['fields'];
    protected $guarded = ['image', 'media'];
    public $fillable = ['content', 'model', 'model_id', 'type', 'link'];
